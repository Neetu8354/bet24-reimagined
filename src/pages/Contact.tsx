...
const Contact = () => {
  useSeo({
    ...
    description: "Get 24x7 support for login, deposits, withdrawals and games on Khelo24App.live.",
    canonical: "/contact",
    keywords: "khelo24app contact, 24x7 support, betting support, customer service",
  });
